    ...
    **External dependencies**
    ...
    def calc_rates(self, day, drv):
        ...
        if r.Ndemand == 0:
            ...
            r.RNuptakeLV = max(0.,min(r.NdemandLV/delt + r.RNtranslocationLV, (r.RNuptake + r.RNfixation) * (r.NdemandLV/delt + r.RNtranslocationLV) / r.Ndemand)) # Modified by Nadia Testani, Annimari Hartikainen and Taru Palosuo, to include fixation in the organs
